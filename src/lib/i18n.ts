...
export const translations = {
  rw: {
    ...
    profile: {
      ...
      noBillingDataSubtitle: 'Iyandikishe kuri gahunda cyangwa ugure amasomo kugirango urebe amakuru y\'ubwishyu bwawe',
  ...
  en: {
    ...
    profile: {
      ...
      noBillingDataSubtitle: 'Subscribe to a plan or purchase a course to see your billing information',
